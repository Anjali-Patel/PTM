...
public class EquipmentLinkedTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    public EquipmentLinkedTableAdapter(Context context, int rowCount, int colCount) {
    ...
    public void onBindHeaderColumnViewHolder(@NonNull ViewHolderImpl viewHolder, int column) {
        ...
        if(EquipmentHeadings.size()>column-1){
            vh.tvText.setText(EquipmentHeadings.get(column - 1));  // skip left top header
