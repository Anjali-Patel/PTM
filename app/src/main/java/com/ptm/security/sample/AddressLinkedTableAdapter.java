...
public class AddressLinkedTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    public AddressLinkedTableAdapter(Context context, int rowCount, int colCount) {
    ...
    switch (column) {
      ...
      /*  case 6:
            ...
            break;
        case 7:
            itemData = address.getPrj_lead();
            break;
        case 8:
            itemData = address.getStatus();
            break;
        case 9:
            itemData = address.getReg_date();
            break;*/
        default:
            break;
...
if(AddressHeadings.size()>column-1){
    vh.tvText.setText(AddressHeadings.get(column -1));  // skip left top header
