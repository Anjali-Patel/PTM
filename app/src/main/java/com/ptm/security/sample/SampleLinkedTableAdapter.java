...
public class SampleLinkedTableAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    public SampleLinkedTableAdapter(Context context, int rowCount, int colCount) {
    ...
    public void onBindHeaderColumnViewHolder(@NonNull ViewHolderImpl viewHolder, int column) {
       ...
       if(ProjectHeadings.size()>column-1){
           vh.tvText.setText(ProjectHeadings.get(column - 1));
...
//        vh.tvText.setSelected(true);
    ...
    private static class TestViewHolder extends ViewHolderImpl {
        TextView tvText;
        ImageView ivImage;
RelativeLayout relative_layout,relative_layout1,relative_column;
        private TestViewHolder(@NonNull View itemView) {
            ...
            relative_column=itemView.findViewById(R.id.relative_column);
        }
    }
